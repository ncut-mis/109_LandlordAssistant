                                        ...
                                        <div class="card-body">
                                            <div class="mb-3 row">
                                                <label for="html5-date-input"
                                                       class="col-md-2 col-form-label">費用開始日期</label>
                                            ...
                                            <div class="mb-3 row">
                                                <label for="html5-date-input"
                                                       class="col-md-2 col-form-label">費用結束日期</label>
                                            ...
                                            <div class="mb-3 row">
                                                <label for="defaultSelect" class="col-md-2 col-form-label">費用類型</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="html5-text-input"
                                                       class="col-md-2 col-form-label">費用金額</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="mb-3 row">
                                                <label for="html5-text-input"
                                                       class="col-md-2 col-form-label">備註</label>
                                                <div class="col-md-10">
