...
@section('page-content')
    ...
    <script>
        ...
        const saveAndAdd = document.getElementById('save-and-add');
...
{{--                                                        <option value="租金">租金</option>--}}
                                ...
                                <a id="save-and-add" class="btn btn-info" href="{{route('houses.expenses.create',[$houses->id])}}">儲存並新增下一筆</a>
