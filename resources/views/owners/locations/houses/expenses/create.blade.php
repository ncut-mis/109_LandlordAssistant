...
@section('page-content')
    ...
    <form method="post" action="{{ route('houses.expenses.store',['house' => $houses->id]) }}">
        ...
        <div class="house" style="padding: 20px;border: 1px solid #ccc;display: block;">
            ...
            <div class="content">
                <div class="row mb-3">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">費用開始日期</label>
                    <label for="inputPassword3" class="col-sm-2 col-form-label">費用結束日期</label>
                    <div class="col-sm-7">
                        <input id="start_date" type="date" name="start_date">
                        <input id="start_date" type="date" name="end_date">
                    </div>
                </div>
            </div>
