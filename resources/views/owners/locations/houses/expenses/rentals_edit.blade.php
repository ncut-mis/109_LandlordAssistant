                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <!-- Tabs -->
                            <form method="post" action="{{ route('houses.expenses_rentals.update',[$expenses->id]) }}">
                                @csrf
                                @method('PATCH')
                                @foreach($houses as $houses)
                                <h3 class="my-1 fw-semibold">新增 {{$houses->name}} 費用</h3>@endforeach
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" name="interval" id="interval" onchange="calculateAmount()" value="{{$expenses->interval}}" placeholder="單位: 月">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-3">
                                                    <input class="form-control" type="date" name="start_date" onchange="calculateEndDate()" value="{{$expenses->start_date}}">
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <input class="form-control" type="date" name="end_date" onchange="calculateStarDate()" value="{{$expenses->end_date}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" type="text" name="amount" id="amount" value="{{$expenses->interval * $houses->rentals}}">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                ...
                                <button type="submit" class="btn btn-info mx-3">修改租金費用</button>
