...
<div class="row px-4 py-4">
	<div class=""><a class="btn btn-outline-secondary" href="{{ route('owners.home.index',[$owner_id,$location->id]) }}">返回</a></div>
...
<div class="house" style="padding: 20px;border: 1px solid #ccc;">
	...
	<div class="tab-content">
					...
					<div class="row">
						<div class="row_house">
							...
							<div class="column" style="width:15%;transform: translate(0%, -10%);">
								<a class="btn btn-primary" href="{{ route('owners.houses.show', $house->id) }}">進入房屋</a>
							</div>
						</div>
					</div>
				@endforeach
		...
		<div class="tab-pane fade" id="house-listed" role="tabpanel" style="padding: 20px;border: 1px solid #ccc;" aria-labelledby="house-listed-tab">
			<div class="row">
				@if(count($location->houses)>0)
					<div class="row">
						<div class="left-column" style="width:20%;padding: 15px;">房屋名稱</div>
		...
		<div class="tab-pane fade" id="house-vacancy" role="tabpanel" style="padding: 20px;border: 1px solid #ccc;" aria-labelledby="house-vacancy-tab">
			<div class="row">
				@if(count($location->houses)>0)
					<div class="row">
						<div class="left-column" style="width:20%;padding: 15px;">房屋名稱</div>
