    ...
    <form method="POST" action="{{ route('users.payment.update', $user_id) }}">
        ...
        <div class="main bg-dark py-5 text-light">
            <div class="container my-5">
                <div class="col-span-5 bg-dark text-light py-2 mx-1 border-0 px-1 fs-3"
                     style="border: 0; display: flex; justify-content: center; align-items: center; font-weight: bold;">
                    收付款方式
                </div>
            </div>
